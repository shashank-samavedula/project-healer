              ...
              <CardContent>
                ...
                <div className="dashboard-grid profile-container">
                  ...
                  <div className="dashboard-grid profile-row">
                    ...
                    <Typography variant="body1">
                      {moment(info.dateOfBirth).format("D MMMM YYYY")}
                    </Typography>
                  </div>
                  <Divider className="dashboard-grid divider" />
                  <div className="dashboard-grid profile-row">
                    <Typography variant="body1">Specializations</Typography>
                    <div className="dashboard-grid specialization chips">
                      {info.specialization.map((specialization, index) => (
                        <Chip key={index} label={specialization} />
                      ))}
                    </div>
                  </div>
                  <Divider className="dashboard-grid divider" />
