...
import { actionDoctorSignUp } from "../../../../actions/app.action";
  ...
  handleSignUp = () => {
    ...
    if (
      ...
      if (specialization.length === 0) {
        errorObj.specializationError = "Select at least 1 specialization";
      }
        ...
        <Grid item>
          ...
          >
            ...
            <div className="sign-up-grid content">
              ...
              <FormControl
                className="sign-up-grid specialization main"
                required
              ...
              >
                ...
                <Select
                  ...
                  renderValue={selected => (
                    <div className="sign-up-grid specialization chips">
                      {selected.map(value => (
                        <Chip
                          key={value}
                          label={value}
                          className="sign-up-grid specialization chip"
                        />
                      ))}
                    </div>
                  )}
